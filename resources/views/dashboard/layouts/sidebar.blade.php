    ...
    <nav class="vertnav navbar navbar-light">
      ...
      <ul class="navbar-nav flex-fill w-100 mb-2">
        <li class="nav-item dropdown">
          <a href="{{ route('dashboard.home') }}"  aria-expanded="false" class=" nav-link">
      ...
      <ul class="navbar-nav flex-fill w-100 mb-2">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="collapse list-unstyled pl-4 w-100" id="forms">
            ...
            <li class="nav-item">
              <a class="nav-link pl-3" href="{{ route('dashboard.products.index') }}"><span class="ml-1 item-text">المنتجات</span></a>
            </li>
